...
public:
     ...
     */
    InertialMeasurementUnit(std::string imu_name, osg::Node *imu_parent, osg::Matrixd rMl, double imu_std=0): name(imu_name), parent_(imu_parent), rMl_(rMl), std_(imu_std) {
