...
#ifndef OSGMANIPULATOR_CUSTOMERTABPLANEDRAGGER
#define OSGMANIPULATOR_CUSTOMERTABPLANEDRAGGER 1
 ...
 */
class OSGMANIPULATOR_EXPORT CustomTabPlaneDragger : public CompositeDragger
{
    public:

        CustomTabPlaneDragger();

        META_OSGMANIPULATOR_Object(osgManipulator,CustomTabPlaneDragger)
        ...
        osg::ref_ptr< Scale2DDragger > getCorners();
        osg::ref_ptr<Scale1DDragger> getHorzEdge();
        osg::ref_ptr<Scale1DDragger> getVertEdge();
