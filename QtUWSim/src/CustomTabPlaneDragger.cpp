...
std::vector<osg::Node*> createCornerScaleDraggerGeometry(Scale2DDragger* cornerScaleDragger, osg::Node* handleNode, float handleScaleFactor)
{
	std::vector<osg::Node*> corners;
...
CustomTabPlaneDragger::CustomTabPlaneDragger() : _handleScaleFactor(20.0)
{
...
CustomTabPlaneDragger::~CustomTabPlaneDragger()
{
}

bool CustomTabPlaneDragger::handle(const PointerInfo& pointer, const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa)
{
...
void CustomTabPlaneDragger::setupDefaultGeometry(bool twoSidedHandle)
{
    osg::ref_ptr<osg::Node> handleNode = createHandleNode(_cornerScaleDragger.get(), _handleScaleFactor, twoSidedHandle);
    corners=createCornerScaleDraggerGeometry(_cornerScaleDragger.get(), handleNode.get(), _handleScaleFactor);
...
osg::ref_ptr< Scale2DDragger > CustomTabPlaneDragger::getCorners(){
	return _cornerScaleDragger;
}
osg::ref_ptr< Scale1DDragger > CustomTabPlaneDragger::getHorzEdge(){
	return _horzEdgeScaleDragger;
}
osg::ref_ptr< Scale1DDragger > CustomTabPlaneDragger::getVertEdge(){
	return _vertEdgeScaleDragger;
}
