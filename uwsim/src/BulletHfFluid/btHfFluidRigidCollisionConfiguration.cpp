    ...
    btDefaultCollisionConfiguration(constructionInfo)
{
  ...
  m_hfFluidBuoyantShapeCollisionCreateFunc = new (mem) btHfFluidBuoyantShapeCollisionAlgorithm::CreateFunc(
      m_simplexSolver, m_pdSolver);

  //COMPOUND_SHAPE_PROXYTYPE
  mem = btAlignedAlloc(sizeof(BuoyantShapeConvexCollisionAlgorithm::CreateFunc), 16);
  m_BuoyantShapeCompoundCreateFunc = new (mem) BuoyantShapeConvexCollisionAlgorithm::CreateFunc(
      m_simplexSolver, m_pdSolver, COMPOUND_SHAPE_PROXYTYPE);

  mem = btAlignedAlloc(sizeof(BuoyantShapeConvexCollisionAlgorithm::CreateFunc), 16);
  m_swappedBuoyantShapeCompoundCreateFunc = new (mem) BuoyantShapeConvexCollisionAlgorithm::CreateFunc(
      m_simplexSolver, m_pdSolver, COMPOUND_SHAPE_PROXYTYPE);
  m_swappedBuoyantShapeCompoundCreateFunc->m_swapped = true;

  //CONCAVE_SHAPE_PROXYTYPE
  mem = btAlignedAlloc(sizeof(BuoyantShapeConvexCollisionAlgorithm::CreateFunc), 16);
  m_BuoyantShapeConcaveCreateFunc = new (mem) BuoyantShapeConvexCollisionAlgorithm::CreateFunc(
      m_simplexSolver, m_pdSolver, TRIANGLE_MESH_SHAPE_PROXYTYPE);

  mem = btAlignedAlloc(sizeof(BuoyantShapeConvexCollisionAlgorithm::CreateFunc), 16);
  m_swappedBuoyantShapeConcaveCreateFunc = new (mem) BuoyantShapeConvexCollisionAlgorithm::CreateFunc(
      m_simplexSolver, m_pdSolver, TRIANGLE_MESH_SHAPE_PROXYTYPE);
  m_swappedBuoyantShapeConcaveCreateFunc->m_swapped = true;

  //CONVEX_SHAPE_PROXYTYPE
  mem = btAlignedAlloc(sizeof(BuoyantShapeConvexCollisionAlgorithm::CreateFunc), 16);
  m_BuoyantShapeConvexCreateFunc = new (mem) BuoyantShapeConvexCollisionAlgorithm::CreateFunc(m_simplexSolver,
                                                                                              m_pdSolver,
                                                                                              CONVEX_SHAPE_PROXYTYPE);

  mem = btAlignedAlloc(sizeof(BuoyantShapeConvexCollisionAlgorithm::CreateFunc), 16);
  m_swappedBuoyantShapeConvexCreateFunc = new (mem) BuoyantShapeConvexCollisionAlgorithm::CreateFunc(
      m_simplexSolver, m_pdSolver, CONVEX_SHAPE_PROXYTYPE);
