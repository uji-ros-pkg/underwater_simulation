...
static bool intersect(btVoronoiSimplexSolver* simplexSolver, const btTransform& transformA,
                      const btTransform& transformB, btConvexShape* a, btConvexShape* b)
{
...
void btHfFluidBuoyantConvexShape::generateShape(btScalar radius, btScalar gap)
{
  ...
  btVector3* voxelPositions = (btVector3*)btAlignedAlloc(
